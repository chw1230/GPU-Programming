...
int main()
{
 ...
 //   glDeleteShader(fragmentShader);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        float ourBright = static_cast<float>(sin(timeValue) / 2.0f) + 0.5f;  // 0.0 ~ 1.0

        // uniform 위치 찾기
        //int brgithLoc = glGetUniformLocation(shaderProgram, "ourBright");
        //glUseProgram(shaderProgram);
        // 삼각형 색상 설정
        //glUniform1f(brgithLoc, ourBright);
        ourShader.setFloat("ourBright", ourBright);
